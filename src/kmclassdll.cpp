...
extern "C" __declspec(dllexport) void __cdecl NetStop();
extern "C" __declspec(dllexport) void __cdecl NetStart();
...
void __cdecl NetStop()
{
	DWORD dwOutput;

	DeviceIoControl(drvhandle2, IOCTL_NETSTOP, 0, 0, NULL, 0, &dwOutput, NULL);

}
void __cdecl NetStart()
{
	DWORD dwOutput;

	DeviceIoControl(drvhandle2, IOCTL_NETSTART, 0, 0, NULL, 0, &dwOutput, NULL);
...
if (ul_reason_for_call==DLL_PROCESS_ATTACH)
  { LoadNTDriver((char*)"kmclass", (char*)"kmclass.sys");
	LoadNTDriver((char*)"Netfilter", (char*)"Netfilter.sys");
	...
	drvhandle2 = CreateFileA("\\\\.\\Netfilter",
		GENERIC_WRITE | GENERIC_READ,
		0,
		NULL,
		OPEN_EXISTING,
